...
DROP INDEX "IX_ShelterNeeds_ShelterId"
/

ALTER TABLE "ShelterNeeds" ADD "Avaliable" NUMBER(10) DEFAULT 0 NOT NULL
/

CREATE INDEX "IX_ShelterNeeds_ShelterId" ON "ShelterNeeds" ("ShelterId")
/

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES (N'20240507205156_ShelterNeedsAvaliable', N'8.0.4')
/
